...
public class JavaLangNumber {
    ...
    public void integerMinMaxCheckBinary() {
        ...
        System.out.println("Integer BINARY min=" + Integer.toHexString(Integer.MIN_VALUE));
        System.out.println("Integer BINARY max=" + Integer.toHexString(Integer.MAX_VALUE));
    }
}
